				...
				<div id="section" class="page-section">
					<div class="container clearfix text-center">
						<h2 class="mx-auto bottommargin font-body" style="max-width: 700px; font-size: 40px;">
							On Going <u>Individual</u> Heroes</h2>
						...
						<div id="portfolio" class="portfolio row grid-container gutter-20" data-layout="fitRows">
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_individual_details.php','_self')"><img src="imgs/index/2.jpg" alt=""></div>
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_individual_details.php','_self')"><img src="imgs/index/8.jpg" alt=""></div>
									<div class="portfolio-desc">
										<h3 >Simon Tan </h3>
										<span>Kuala Lumpur, Malaysia<br/>$145,000 </span>
										<a href="#" class="btn btn-success col-12">Donate</a>
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_individual_details.php','_self')"><img src="imgs/index/4.jpg" alt=""></div>
									<div class="portfolio-desc">
										<h3 >Simon Tan </h3>
										<span>Kuala Lumpur, Malaysia<br/>$145,000 </span>
										<a href="#" class="btn btn-success col-12">Donate</a>
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_individual_details.php','_self')"><img src="imgs/index/3.jpg" alt=""></div>
									<div class="portfolio-desc">
										<h3 >Simon Tan </h3>
										<span>Kuala Lumpur, Malaysia<br/>$145,000 </span>
										<a href="#" class="btn btn-success col-12">Donate</a>
