						...
						<div id="portfolio" class="portfolio row grid-container gutter-20" data-layout="fitRows">
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_group_details.php','_self')"><img src="imgs/group/group1.jpg" alt=""></div>
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_group_details.php','_self')"><img src="imgs/group/group2.jpg" alt=""></div>
									<div class="portfolio-desc">
										<h3 >Simon Tan </h3>
										<span>Kuala Lumpur, Malaysia<br/>$145,000 </span>
										<a href="#" class="btn btn-success col-12">Donate</a>
							...
							<article class="portfolio-item col-lg-1-5 col-md-4 col-sm-4 pf-graphics">
								<div class="grid-inner">
									<div class="portfolio-image jhand" onClick="window.open('heroing_group_details.php','_self')"><img src="imgs/group/group3.jpg" alt=""></div>
									<div class="portfolio-desc">
										<h3 >Simon Tan </h3>
										<span>Kuala Lumpur, Malaysia<br/>$145,000 </span>
										<a href="#" class="btn btn-success col-12">Donate</a>
